...
<!--        <h3 id="comments-list-title">Comments --><?php //$this->commentsNum(_t('NOTHING'), _t('<span class="noticom">1</span>条评论'), _t('<span class="noticom">%d</span>条评论')); ?><!-- </h3>-->
        <!-- 评论内容 -->
                    ...
                    <div class="row">
                        ...
                        <div class="textfield">
                            <input class="textfield-input" type="text" name="url" id="url"
                                placeholder="Url"   value="<?php $this->remember('url'); ?>">
                        </div>
                    </div>
                    <?php endif; ?>
                    <div class="row">
                        <div class="textfield textfield-textarea">
                            <textarea name="text" id="comment" class="OwO-textarea textfield-input" rows="4" placeholder="说点什么呗 QAQ" style="resize: none"></textarea>
                        </div>
                    </div>
