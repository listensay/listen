declare global {
  ...
  const errorHandle: typeof import('../../server/utils/serverUtils')['errorHandle']
  ...
  const successHandle: typeof import('../../server/utils/serverUtils')['successHandle']
  ...
  const usePrisma: typeof import('../../server/utils/serverUtils')['usePrisma']
...
export { successHandle, errorHandle, usePrisma } from '../../server/utils/serverUtils';