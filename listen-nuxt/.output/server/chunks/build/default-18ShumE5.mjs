import { withAsyncContext, ref, mergeProps, useSSRContext, shallowRef, toRef, getCurrentInstance, onServerPrefetch, unref } from 'vue';
import { f as useRoute, b as navigateTo, c as asyncDataDefaults, d as useNuxtApp, e as createError } from './server.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const r = ([__temp, __restore] = withAsyncContext(() => useRequest("/api/checkInstalled")), __temp = await __temp, __restore(), __temp);
...
//# sourceMappingURL=default-18ShumE5.mjs.map
